...
from networks.PSCTNet import CTHFNet
...
parser.add_argument('--output_dir', type=str,
                    default='./testout_2', help='output dir')
...
if __name__ == "__main__":
    ...
    args.output_dir = './trainout'

    net = CTHFNet(num_classes=args.num_classes).cuda(0)
    ...
    # else:
    #     test_save_path = None
    test_save_path = os.path.join("./testout_2", "predictions")
